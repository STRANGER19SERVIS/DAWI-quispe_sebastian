package pe.edu.i202215458.cl1_jpa_data_Quispe_Sebastian;
...
import pe.edu.i202215458.cl1_jpa_data_Quispe_Sebastian.repository.CountryRepository;

import java.util.List;
import java.util.stream.Collectors;

@SpringBootApplication
public class Cl1JpaDataQuispeSebastianApplication  implements CommandLineRunner {

	public static void main(String[] args) {SpringApplication.run(Cl1JpaDataQuispeSebastianApplication.class, args);
